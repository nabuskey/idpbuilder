...
func (g *RemoteRepository) CloneUrl() string {
	sb := strings.Builder{}
	if g.Scheme != "" {
...
func (g *RemoteRepository) Path() string {
	return g.FilePath
}

func (g *RemoteRepository) parseQuery() error {
...
func (g *RemoteRepository) parse() error {
...
func (g *RemoteRepository) parseSCPStyle() error {
...
func (g *RemoteRepository) parsePath(path string) error {
...
func NewRemoteRepository(uri string) (*RemoteRepository, error) {
	r := &RemoteRepository{raw: uri}
